...
//	LCD_WR_REG_DATA(0x0003, 0x1008); // set GRAM write direction and BGR=1. //1030
	...
	delay_ms(20); 
	LCD_WR_REG_DATA(0x30, 0x0202);	
	LCD_WR_REG_DATA(0x31, 0x0403);		
	LCD_WR_REG_DATA(0x32, 0x0007);
	LCD_WR_REG_DATA(0x33, 0x0402);
	LCD_WR_REG_DATA(0x34, 0x0007);				
	LCD_WR_REG_DATA(0x35, 0x0403);		
	LCD_WR_REG_DATA(0x36, 0x0505);		
	LCD_WR_REG_DATA(0x37, 0x0204);	
	LCD_WR_REG_DATA(0x38, 0x080e);		
	LCD_WR_REG_DATA(0x39, 0x080e);
	delay_ms(20);
	...
	LCD_WR_REG_DATA(0x90, 0x003c); //0x003c(60)//0x0044(68)  //0x0058(90)
	LCD_WR_REG_DATA(0x92, 0x010F);
	LCD_WR_REG_DATA(0x93, 0x0701);
	LCD_WR_REG_DATA(0x9A, 0x0005);
